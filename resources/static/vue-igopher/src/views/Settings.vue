    ...
    config.ready(() => {
      astor.onIsReady(function() {
        ...
        document.querySelector("#resetGlobalDefaultSettingsBtn").addEventListener("click", function() {
            astor.trigger("resetGlobalDefaultSettings", {}, function(message: any) {
        ...
        document.querySelector('#igCredentialsFormBtn').addEventListener("click", function(e) {
            ...
            let form = document.querySelector('#igCredentialsForm') as HTMLFormElement;
        ...
        document.querySelector('#schedulerFormBtn').addEventListener("click", function(e) {
            ...
            let form = document.querySelector('#schedulerForm') as HTMLFormElement;
            if (!form.checkValidity()) {
                e.preventDefault()
                e.stopPropagation()
            } else {
        ...
        document.querySelector('#blacklistFormBtn').addEventListener("click", function(e) {
            ...
            let form = document.querySelector('#blacklistForm') as HTMLFormElement;
            if (!form.checkValidity()) {
                e.preventDefault()
                e.stopPropagation()
            } else {
        ...
        document.querySelector('#proxyAuthCheck').addEventListener("change", function() {
            let checkbox = document.querySelector('#proxyAuthCheck') as HTMLInputElement
...
function fillInputs() {
  ...
  const dmDayField = document.getElementById(
    "dmDayInput"
  ) as HTMLInputElement
  ...
  const endAtField = document.getElementById(
    "endAtInput"
  ) as HTMLInputElement
  endAtField.value = config.igopherConfig.schedule.endAt;

  const ipProxyField = document.getElementById(
    "ipInput"
  ) as HTMLInputElement
