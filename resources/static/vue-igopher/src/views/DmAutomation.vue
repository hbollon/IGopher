      ...
      astor.onIsReady(function() {
        ...
        dmBotLaunchBtn.addEventListener("click", function() {
          if (dmBotRunning === "false" || dmBotRunning === null) {
            ...
            astor.trigger("stopDmBot", {}, function(message: any) {
              if (message.status === config.SUCCESS) {
                config.Toast.fire({
                  icon: "success",
                  title: message.msg,
        ...
        dmBotHotReloadBtn.addEventListener("click", function() {
          ...
          astor.trigger("hotReloadBot", {}, function(message: any) {
            if (message.status === config.SUCCESS) {
              config.Toast.fire({
                icon: "success",
                title: message.msg,
...
function fillInputs() {
  ...
  const srcUsersField = document.getElementById("srcUsers") as HTMLInputElement;
